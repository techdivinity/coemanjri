...
<div class="wrapper row1">
    <header id="header" class="clear" style="margin-top: -30px;"> 
    <!-- ################################################################################################ -->
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_half" > 
          ...
          <div class="panel-heading"> 
                <h3 class="text-center"> Sign In to <strong class="text-custom">COE Admin</strong> </h3>
            </div> 
            ...
            <form class="form-horizontal m-t-20" action="Login" method="post">
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" required="" placeholder="Username" name="userName1">
                    </div>
                </div>
